...
```
6. Run shell script with email addresses to notify: `source run.sh "email1@domain.com{string1|string2}" "email2@domain.com{string1&string2|string3}" ...`. Optionally, AND-filters (&) and OR-filters (|) can be used.
